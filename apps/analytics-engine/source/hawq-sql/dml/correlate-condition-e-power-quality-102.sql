...
FROM   ( 
       ...
       (
        ...
        WHERE 
         CM.correlation_code = 'E_POWER_QUALITY_102'
       ) TMP2, 
       grid.component               CP 
WHERE 
...
AND grid.contains_condition_code(TMP1.condition_array, $7, $8) 
 ; 

EXECUTE correlation_instance('LOW_VOLTAGE_NEVER_CLOSED_3PHASE',
                             grid.getCorrelationThreshold('E_POWER_QUALITY_102',
                                                          'CONDITION_CODE',
                                                          'LOW_VOLTAGE_NEVER_CLOSED_3PHASE'),
