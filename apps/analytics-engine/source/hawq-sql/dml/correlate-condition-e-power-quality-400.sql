...
FROM   ( 
       ...
       (
        ...
        WHERE 
         CM.correlation_code = 'E_POWER_QUALITY_400'
       ) TMP2, 
       grid.component               CP 
WHERE 
...
EXECUTE correlation_instance('LOW_VOLTAGE_HIGH_FLUCTUATION',
                             grid.getCorrelationThreshold('E_POWER_QUALITY_400',
                                                          'CONDITION_CODE',
                                                          'LOW_VOLTAGE_HIGH_FLUCTUATION'),
